...
# Опционально: RESEND_USER_AGENT='Calender/1.0'
python app.py
```
...
- Запросы к Resend отправляются с заголовком `User-Agent`; без него Resend может вернуть Cloudflare 403 / error code 1010.
